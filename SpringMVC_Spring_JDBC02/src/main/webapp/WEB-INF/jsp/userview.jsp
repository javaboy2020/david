...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
			...
			<div>
                <label>用户证件照:</label>
                <img src="${pageContext.request.contextPath}/uploads/images/${user.idPicPath}" alt="用户证件照"><br>
                <label>用户工作证:</label>
                <img src="${pageContext.request.contextPath}/uploads/images/${user.workPicPath}" alt="用户工作证"><br>
            </div>
